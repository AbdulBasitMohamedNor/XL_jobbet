...
namespace XL_jobbet
{
    public partial class Form1 : Form
    {
                   ...
                   // MessageBox.Show("opening_Layer is : " + openingLayer.ToString());
                    ...
                    if (counter == 2)
                    {
                       //MessageBox.Show("Counter value is : " + counter.ToString());
                        createOpening(openingLayer.ToString(), "60%", "E");
                        counter++;
                    }
                    if (counter == 1)
                    {
                       //MessageBox.Show("Counter value is : " + counter.ToString());
                        createOpening(openingLayer.ToString(), "60%", "D");
                        counter++;
                    }
                    ...
                    {
                        //MessageBox.Show("Counter value is : " + counter.ToString());
                        createOpening(openingLayer.ToString(), "50%", "C");
                        counter++;
                    }
        ...
        void createOpening(string openingLayer, string procent, string column)
        {
